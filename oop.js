...
var uni1 = new Unicorn("Bob");
console.log(uni1)

uni1.say("Hi, I'm Bob the Unicorn");
...
var vamp1 = new Vampire("Vlad");
console.log(vamp1);

vamp1.changePet("snake");
console.log(vamp1);
...
var drag1 = new Dragon("Bill", "Will", "Red");
console.log(drag1);
...
var hob1 = new Hobbit("Frodo", "Happy");
